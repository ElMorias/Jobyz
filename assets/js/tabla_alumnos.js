...
//----------------get gestionar el modal de ver detalles usuario --------------------------//
    ...
    //----------------get gestionar el modal de modificar usuario --------------------------//
    ...
    if (e.target.classList.contains('btn-modificar')) {
        ...
        modalManager.crearModalDesdeUrl('assets/modales/modalModificar.txt', function () {
            ...
            form.addEventListener('submit', function (e) {
                ...
                fetch('api/apiAlumno.php', {
                    method: 'POST', // Usa POST y distingue en PHP si es alta/modificación vía presence de id
                    body: formData
                })
                .then(res => res.json())
                .then(resp => {
