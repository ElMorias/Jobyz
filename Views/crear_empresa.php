<?php $this->layout('base_simple', ['title' => 'Creación de empresa']) ?>
...
<section class="registro-container">
  ...
  <form action="" method="POST" id="form-crear-empresa" class="form-crear-empresa" enctype="multipart/form-data">
    ...
    <button type="submit" class="btn-registro">Crear empresa</button>
  </form>
